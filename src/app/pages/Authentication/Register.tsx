    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="max-h-96 overflow-y-auto py-4">
          ...
          <p>Tất cả nội dung trên trang web của chúng tôi, bao gồm văn bản, đồ họa, logo, biểu tượng, hình ảnh, và phần mềm, đều thuộc sở hữu của Eco Brew Cycle và được bảo vệ bởi luật sở hữu trí tuệ.</p>
